...
- **For each public class** in the file, write a compact entry with its name, a one-line description, and a list of its public methods with signatures and brief notes.
